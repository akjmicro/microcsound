...
def test_pedal_string():
    ...
    with mock.patch("microcsound.main.live_input_func", dummy_live_input_func(fp)):
        ...
        result_2 = process_buffer(result, rt_mode=True)
    expected = (
        "i1.0 8.000 20.000  -3  0.0  0.5  0  \n"
        "i1.0 16.000 12.000  -3  1.0  0.5  0  \n"
        "i1.0 20.000 8.000  -3  2.0  0.5  0  \n"
        "i1.0 24.000 4.000  -3  3.0  0.5  0"
    )
    assert expected in result_2[1]
...
def test_chord_handling():
    ...
    with mock.patch("microcsound.main.live_input_func", dummy_live_input_func(fp)):
        ...
        result_2 = process_buffer(result, rt_mode=True)
    expected = (
        "i1.0 0.000 3.980  -3.0  0.0  0.5  0  \n"
        "i1.0 0.000 3.980  -3.0  1.0  0.5  0  \n"
        "i1.0 4.000 3.980  -6.5  2.0  0.5  0  \n"
        "i1.0 8.000 3.980  -3.0  3.0  0.5  0  \n"
        "i1.0 8.000 3.980  -3.0  4.0  0.5  0  \n"
        "i1.0 12.000 3.980  -3.0  5.0  0.5  0  \n"
    )
    assert expected in result_2[1]
