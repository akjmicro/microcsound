...
### triggered at the same time. Whitespace isn't significant, but serves
### To highlight the two mixer setup statments
1: div=0 i=201 1    &-1    i=202 "0.5%0.0%0.0%0.0" 1  &-1
### Instrument setup
1: i=1.1 "3%0.01%0%1%0.2" pan=0.9 mix=0 div=53 gs=10.6 r3 @-3
2: i=1.2 "4%0.01%0%1%0.2" pan=0.1 mix=0 div=53 gs=10.6 r3 @-6
3: i=1.3 "2%0.01%0%1%0.2" pan=0.5 mix=0 div=53 gs=10.6 r3 @-2
4: i=120  mix=0 pan=0.5 div=0 r3
5: i=120  mix=0 pan=0.5 div=0 r3
### The pre-chant:
...
4: 1/8 @-3 0 r 1 r r r | 0 r 1 r r 0 | 0 r 1 r r 0 |
5: 1/8 @-3   r 2 r 2 r 2 | r 2 r 3 2 r | r 2 r 2 r 2 |
### Pax:
...
3: f3 ed2      | c6           | g,6         | f,6         |
4: 0 r 0 r 0 r | 0 r 0 r 0 r  | 0 r 0 r 0 r | 0 r2 1/24 @-3 1
4:                                             @< 1 1 1 1 1 1/8 @-1.9 1 |
...
5: 1/24 r @-5 2 @< 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 | 2 2 2 2 2 2 2 2 2
...
4: @-3.5 0 r r r r r | 0 r r r r r | 0 r 0 r r r | 0 r 0 r r r |
5: @-4.4 r 2 2 2 2 2 | r 2 2 2 2 2 | r 2 r 2 2 2 | r 2 r 2 2 3 |
### Qui Tollis II (m. 65)
...
4:    0 r5   |    0 r5     |    0 r5        | 0 r2  1/24 @-3.5 1 @< 1 1 1 1 1
4:                                             1/8 @-2.5 1 |
5:    r6     |    r6       |    r 2 r 2 r 3 | r 2  r  2  r 2 |
### m. 73:
1:      fga    _bag  | t=147 _bag   f2e | t=140 @-2 f5  r r t=140 || t=150
2:      ag2    a_bc' |       d'c'2 _b2a |       @-2 c'5 r r       ||
3:     _b,2 a,_b,c2  |       f,2 g,4    |       @-2 f,5 r r       ||
4: 3/16 0  r  1  r   |       0  r  1  r |      1/8  0 r6          ||
5: 3/16 r  2  r  2   |    r  3  r @-3 2 |      1/8  r r6          ||
#################################################
...
4: @-3        0 r r r   r r   | 0 r 0 r 1 r | 0 r5     | 0 r 0 r 1 r           |
5: @-4.4 3/16  r 2    r 2     | r 2   r 3   | r  2 r 2 | r 2 r 3/64 3 3 3/32 2 |
### bass 'Tu so-lus'
...
2: "6%0.01%0%1%0.2"
3: "6%0.01%0%1%0.2"
1: @-5.5     a2 @< b c'2c'  | a2b   c'2d' |      b2c' d'2e' |
2: @-5.5     f2 @< f g2g    | f2f   g2a   |      g2g  a2b   |
3: @-5.5     d2 @< d c2c    | d2d   c2c   |      e2e  d2d   |
4: @-1.9 1/8 0 r @< 1 0 r 1 | 0 r 1 0 r 1 | 3/16 0  r  1  0 |
5: @-3.0 1/8 r 3 r r @< 2 r | r 3 r r 2 r | 3/16 r  2  r  3 |
### Dei patris
...
###
1: t=147 e6                               | t=130 @-2.6 f5              r r r t=130 ||
2:       b6                               |       @-2.6 c'5             r r r       ||
3:       g,6                              |       @-2.6 f,5             r r r       ||
4: 1/16  0 3 1 0 2 1 0 3 [0 1] r [0 1] r  | 1/8         0 r @-2   0 r r r r r       ||
5: 1/16  r8               3    r  3    r  | 1/8         r 3 @-3   2 r r r r r       ||
##### extra layer CUM SANCTO:
1: &-44 "2%0.01%0%1%0.2" mix=-4
2: &-44 "2%0.01%0%1%0.2" mix=-4
3: &-44 "2%0.01%0%1%0.2" mix=-4
1: @-5 a2 @< b c'2c' | a2b c'2d' | b2c' d'2e' |
2: @-5 f2 @< f g2g   | f2f g2a   | g2g  a2b   |
3: @-5 d2 @< d c2c   | d2d c2c   | e2e  d2d   |
1:       d'e'd' c'2b | c'_ba g2f | e6         | @-2.2 f5  r r r ||
2:       a2  g2  ^f2 | g2 r2 a2  | b6         | @-2.2 c'5 r r r ||
3:       f2  e2  d2  | c6        | g,6        | @-2.2 f,5 r r r ||
##########
## AMEN ##
##########
1: "3%0.01%0%1%0.2"  t=147 mix=0.7
2: "4%0.01%0%1%0.2"        mix=-1.5
3: "2%0.01%0%1%0.2"        mix=0.7
1:     @-3   (c'4 @< a_b    | c'3 d'_bc'  |    a2) r2 (b2  | c'3 bc'a    |
2:     @-4   (f3 @<  efd    | c6          |    d2 e2 f2)   | r(g a2 g2)  |
3:     @-3   f,6-           | f,6         | @< (f3  efd    | c2) r2 (c2  |
4: 1/8 @-1.8 0 r @< 1 r r 0 | 0 r 0 r 1 r |    0 r 1 r r 0 | 0 r 0 r 1 r |
5: 1/8 @-2.6 r 2 r @< 3 2 r | r 2 r 3 r 2 |    r 2 r 3 2 r | r 2 r 3 r 2 |
###
...
1: &-109 i=1.4 "2%0.01%0%1%0.2" mix=0 @-8
2: &-109 i=1.5 "2%0.01%0%1%0.2" mix=0 @-8
3: &-109 i=1.6 "2%0.01%0%1%0.2" mix=0 @-8
